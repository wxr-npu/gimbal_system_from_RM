...
1. [`README.md`](./README.md) for the current upper-level mainline overview
2. [`scripts/README.md`](./scripts/README.md) for deployment and startup entry points
3. package-level `README.md` files for current package roles and run commands
